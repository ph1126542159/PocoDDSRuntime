...
def public_types(text: str) -> list[str]:
    pattern = (
        ...
        r"(?:(?:[A-Z][A-Z0-9_]*_API)\s+)?([A-Za-z_][A-Za-z0-9_]*)"
    )
...
def current_surface(root: Path) -> dict[str, Any]:
    header_paths = [
        ...
        "platform/configtransaction/include/PocoDDS/ConfigTransaction/ConfigTransaction.h",
        "platform/configtransaction/include/PocoDDS/ConfigTransaction/ConfigurationParticipantService.h",
        "platform/configtransaction/include/PocoDDS/ConfigTransaction/ConfigurationRuntimeService.h",
        "platform/configtransaction/include/PocoDDS/ConfigTransaction/TransactionEngine.h",
        "platform/configtransaction/include/PocoDDS/ConfigTransaction/TransactionStore.h",
        "platform/configtransaction/include/PocoDDS/ConfigTransaction/SqliteTransactionStore.h",
        "platform/schemaregistry/include/PocoDDS/SchemaRegistry/Schema.h",
        "platform/schemaregistry/include/PocoDDS/SchemaRegistry/SchemaProviderService.h",
        "platform/schemaregistry/include/PocoDDS/SchemaRegistry/SchemaRegistryService.h",
        "platform/schemaregistry/include/PocoDDS/SchemaRegistry/Registry.h",
        "platform/schemaregistry/include/PocoDDS/SchemaRegistry/SchemaStore.h",
        "platform/schemaregistry/include/PocoDDS/SchemaRegistry/SqliteSchemaStore.h",
        ...
        "platform/resourcegovernance/include/PocoDDS/ResourceGovernance/ResourceGovernor.h",
        "platform/resourcegovernance/include/PocoDDS/ResourceGovernance/ManagedWorkLane.h",
        "platform/resourcegovernance/include/PocoDDS/ResourceGovernance/ResourceGovernorService.h",
        "platform/scheduling/include/PocoDDS/Scheduling/Scheduler.h",
        "platform/scheduling/include/PocoDDS/Scheduling/SchedulerService.h",
        "platform/scheduling/include/PocoDDS/Scheduling/ScheduleConfigurationParticipant.h",
        "platform/servicedependency/include/PocoDDS/ServiceDependency/ServiceDependency.h",
        "platform/servicedependency/include/PocoDDS/ServiceDependency/ServiceDependencyRuntimeService.h",
        "platform/membership/include/PocoDDS/Membership/Membership.h",
        "platform/membership/include/PocoDDS/Membership/MembershipRuntimeService.h",
        "platform/membership/include/PocoDDS/Membership/IncarnationStore.h",
        "platform/servicedirectory/include/PocoDDS/ServiceDirectory/Directory.h",
        "platform/servicedirectory/include/PocoDDS/ServiceDirectory/ServiceAdvertisementProvider.h",
        "platform/servicedirectory/include/PocoDDS/ServiceDirectory/ServiceDirectoryRuntimeService.h",
        "platform/serviceclient/include/PocoDDS/ServiceClient/Client.h",
        "platform/serviceclient/include/PocoDDS/ServiceClient/ProviderRegistry.h",
        "platform/serviceclient/include/PocoDDS/ServiceClient/RuntimeCoordinator.h",
        "platform/serviceclient/include/PocoDDS/ServiceClient/ServiceClientRuntimeService.h",
        "platform/serviceclient/include/PocoDDS/ServiceClient/ServiceInvocationProvider.h",
        "platform/lifecycle/include/PocoDDS/Lifecycle/DrainGate.h",
        "platform/lifecycle/include/PocoDDS/Lifecycle/Maintenance.h",
        "platform/lifecycle/include/PocoDDS/Lifecycle/MaintenanceStore.h",
        "platform/lifecycle/include/PocoDDS/Lifecycle/SqliteMaintenanceStore.h",
        "platform/lifecycle/include/PocoDDS/Lifecycle/DrainParticipantService.h",
        "platform/lifecycle/include/PocoDDS/Lifecycle/LifecycleRuntimeService.h",
        "platform/OSP/include/Poco/OSP/BundleLifecycleGuard.h",
    ...
    return {
        ...
        "cmakeTargets": [
            ...
            "PocoDDS::SchedulingAPI",
            "PocoDDS::SchedulingCore",
            "PocoDDS::SchedulingConfiguration",
            "PocoDDS::ServiceDependencyAPI",
            "PocoDDS::ServiceDependencyCore",
            ...
            "PocoDDS::LifecycleAPI",
            "PocoDDS::LifecycleCore",
