...
| Fast-DDS | Two processes discover and exchange typed data using SHM on one host | Missing |
| Cross-host DDS | Two hosts exchange with non-SHM transport and retain trace context | Missing |
